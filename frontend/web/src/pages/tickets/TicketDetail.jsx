      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl border-2 border-orange-200 overflow-hidden">
          <div className="bg-gradient-to-r from-orange-500 to-red-600 p-6 text-white">
            <h1 className="text-3xl font-black mb-2">🎫 {ticket.eventTitle}</h1>
            <p className="text-orange-100">Your NFT Ticket</p>
          </div>
          ...
          <div className="p-8">
            <div className="space-y-6">
              <div className="p-4 bg-orange-50 rounded-lg border-2 border-orange-200">
                ...
                <p className="text-lg font-mono font-bold text-gray-900 break-all">{ticket.id}</p>
              </div>
              ...
              {ticket.qrCode && (
                <div className="p-4 bg-orange-50 rounded-lg border-2 border-orange-200 text-center">
                  ...
                  <img src={ticket.qrCode} alt="Ticket QR Code" className="w-48 h-48 mx-auto" />
                </div>
              )}
            </div>
            ...
            <div className="mt-8 space-y-3">
              <button
                onClick={() => navigate(`/tickets/${ticketId}/manage`)}
